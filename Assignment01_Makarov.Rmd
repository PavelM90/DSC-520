...
```
## Display the amount of sleep on Tuesday of week 1 by selecting the variable index. I assume the week starts from Sunday!
```{r}
week1_sleep[3]
```
...
```{r}
more_than_8_week1 <- week1_sleep > 8
sum(more_than_8_week1)
```
